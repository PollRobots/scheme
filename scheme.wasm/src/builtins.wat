...
(%define %builtin-port? ()                    (i32.const 238))
(%define %builtin-input-port? ()              (i32.const 239))
(%define %builtin-output-port? ()             (i32.const 240))
(%define %builtin-textual-port? ()            (i32.const 241))
(%define %builtin-binary-port? ()             (i32.const 242))
(%define %builtin-input-port-open? ()         (i32.const 243))
(%define %builtin-output-port-open? ()        (i32.const 244))
(%define %builtin-close-port ()               (i32.const 245))
(%define %builtin-open-input-file ()          (i32.const 246))
(%define %builtin-open-binary-input-file ()   (i32.const 247))
(%define %builtin-open-output-file ()         (i32.const 248))
(%define %builtin-open-binary-output-file ()  (i32.const 249))
(%define %builtin-eof-object ()               (i32.const 250))
(%define %builtin-eof-object? ()              (i32.const 251))
(%define %builtin-open-input-string ()        (i32.const 252))
(%define %builtin-string-port? ()             (i32.const 253))
(%define %builtin-string-port-obj ()          (i32.const 254))
(%define %builtin-open-output-string ()       (i32.const 255))
(%define %builtin-open-input-bytevector ()    (i32.const 256))
(%define %builtin-bytevector-port? ()         (i32.const 257))
(%define %builtin-bytevector-port-obj ()      (i32.const 258))
(%define %builtin-open-output-bytevector ()   (i32.const 259))

(table $table-builtin 260 anyfunc)
...
(func $register-builtins (param $heap i32) (param $env i32)
  ...
  (%add-builtin (%str %sym-128 128 "string>=?") (%builtin-string>=?)) ;; 'string>=?'
  (%add-builtin (%str %sym-128 128 "string-ci>=?") (%builtin-string-ci>=?)) ;; 'string-ci>=?'
  ...
  (%add-builtin (%str %sym-128 128 "port?") (%builtin-port?))
  (%add-builtin (%str %sym-128 128 "input-port?") (%builtin-input-port?))
  (%add-builtin (%str %sym-128 128 "output-port?") (%builtin-output-port?))
  (%add-builtin (%str %sym-128 128 "textual-port?") (%builtin-textual-port?))
  (%add-builtin (%str %sym-128 128 "binary-port?") (%builtin-binary-port?))
  (%add-builtin (%str %sym-192 192 "input-port-open?") (%builtin-input-port-open?))
  (%add-builtin (%str %sym-192 192 "output-port-open?") (%builtin-output-port-open?))
  (%add-builtin (%str %sym-128 128 "close-port") (%builtin-close-port))
  (%add-builtin (%str %sym-128 128 "open-input-file") (%builtin-open-input-file))
  (%add-builtin (%str %sym-192 192 "open-binary-input-file") (%builtin-open-binary-input-file))
  (%add-builtin (%str %sym-128 128 "open-output-file") (%builtin-open-output-file))
  (%add-builtin (%str %sym-192 192 "open-binary-output-file") (%builtin-open-binary-output-file))
  (%add-builtin (%str %sym-128 128 "eof-object") (%builtin-eof-object))
  (%add-builtin (%str %sym-128 128 "eof-object?") (%builtin-eof-object?))
  (%add-builtin (%str %sym-192 192 "open-input-string") (%builtin-open-input-string))
  (%add-builtin (%str %sym-192 192 "string-port?") (%builtin-string-port?))
  (%add-builtin (%str %sym-192 192 "string-port-obj") (%builtin-string-port-obj))
  (%add-builtin (%str %sym-192 192 "open-output-string") (%builtin-open-output-string))
  (%add-builtin (%str %sym-192 192 "open-input-bytevector") (%builtin-open-input-bytevector))
  (%add-builtin (%str %sym-192 192 "bytevector-port?") (%builtin-bytevector-port?))
  (%add-builtin (%str %sym-192 192 "bytevector-port-obj") (%builtin-bytevector-port-obj))
  (%add-builtin (%str %sym-192 192 "open-output-bytevector") (%builtin-open-output-bytevector))
...
(elem $table-builtin (%builtin-port?) $port?)
(elem $table-builtin (%builtin-input-port?) $input-port?)
(elem $table-builtin (%builtin-output-port?) $output-port?)
(elem $table-builtin (%builtin-textual-port?) $textual-port?)
(elem $table-builtin (%builtin-binary-port?) $binary-port?)
(elem $table-builtin (%builtin-input-port-open?) $input-port-open?)
(elem $table-builtin (%builtin-output-port-open?) $output-port-open?)
(elem $table-builtin (%builtin-close-port) $close-port)
(elem $table-builtin (%builtin-open-input-file) $open-input-file)
(elem $table-builtin (%builtin-open-binary-input-file) $open-binary-input-file)
(elem $table-builtin (%builtin-open-output-file) $open-output-file)
(elem $table-builtin (%builtin-open-binary-output-file) $open-binary-output-file)
(elem $table-builtin (%builtin-eof-object) $eof-object)
(elem $table-builtin (%builtin-eof-object?) $eof-object?)
(elem $table-builtin (%builtin-open-input-string) $open-input-string)
(elem $table-builtin (%builtin-string-port?) $string-port?)
(elem $table-builtin (%builtin-string-port-obj) $string-port-obj)
(elem $table-builtin (%builtin-open-output-string) $open-output-string)
(elem $table-builtin (%builtin-open-input-bytevector) $open-input-bytevector)
(elem $table-builtin (%builtin-bytevector-port?) $bytevector-port?)
(elem $table-builtin (%builtin-bytevector-port-obj) $bytevector-port-obj)
(elem $table-builtin (%builtin-open-output-bytevector) $open-output-bytevector)