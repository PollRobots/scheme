...
(%define %xxh_prime_1 () (i64.const 0x9E3779B185EBCA87))

;; #define XXH_PRIME64_2  0xC2B2AE3D27D4EB4FULL  /*!< 0b1100001010110010101011100011110100100111110101001110101101001111 */
(%define %xxh_prime_2 () (i64.const 0xC2B2AE3D27D4EB4F))
;; #define XXH_PRIME64_3  0x165667B19E3779F9ULL  /*!< 0b0001011001010110011001111011000110011110001101110111100111111001 */
(%define %xxh_prime_3 () (i64.const 0x165667B19E3779F9))
;; #define XXH_PRIME64_4  0x85EBCA77C2B2AE63ULL  /*!< 0b1000010111101011110010100111011111000010101100101010111001100011 */
(%define %xxh_prime_4 () (i64.const 0x85EBCA77C2B2AE63))
;; #define XXH_PRIME64_5  0x27D4EB2F165667C5ULL  /*!< 0b0010011111010100111010110010111100010110010101100110011111000101 */
(%define %xxh_prime_5 () (i64.const 0x27D4EB2F165667C5))

(%define %XXH_ROTL (%val %num) (i64.rotl (local.get %val) (i64.const %num)))
...
;;     acc += input * XXH_PRIME64_2;
  (local.set $acc (i64.add (local.get $acc) (i64.mul (local.get $input) (%xxh_prime_2))))
;;     acc  = XXH_rotl64(acc, 31);
  (local.set $acc (%XXH_ROTL $acc 31))
;;     acc *= XXH_PRIME64_1;
;;     return acc;
  (return (i64.mul (local.get $acc) (%xxh_prime_1))))
...
(func $xxh64_mergeRound (param $acc i64) (param $val i64) (result i64)
  ...
  ;; acc  = acc * XXH_PRIME64_1 + XXH_PRIME64_4;
  ;; return acc;
  (return (i64.add (i64.mul (local.get $acc) (%xxh_prime_1)) (%xxh_prime_4))))
...
(func $xxh64_avalanche (param $h64 i64) (result i64)
  ...
  ;; h64 *= XXH_PRIME64_2;
  (local.set $h64 (i64.mul (local.get $h64) (%xxh_prime_2)))
  ;; h64 ^= h64 >> 29;
  (local.set $h64 (i64.xor (local.get $h64) (i64.shr_u (local.get $h64) (i64.const 29))))
  ;; h64 *= XXH_PRIME64_3;
  (local.set $h64 (i64.mul (local.get $h64) (%xxh_prime_3)))
  ;; h64 ^= h64 >> 32;
  ;; return h64;
...
(func $xxh64_finalize (param $h64 i64) (param $ptr i32) (param $len i32) (result i64)
  ...
  (block $w8_end (loop $w8_start
      ...
      ;; h64  = XXH_rotl64(h64,27) * XXH_PRIME64_1 + XXH_PRIME64_4;
      (local.set $h64 (i64.add (i64.mul (%XXH_ROTL $h64 27) (%xxh_prime_1)) (%xxh_prime_4)))
      ;; len -= 8;
      (%minus-eq $len 8)
      (br $w8_start)))
  ;; }
  ...
  ;; if (len >= 4) {
  (if (i32.ge_u (local.get $len) (i32.const 4)) (then
      ;; h64 ^= (xxh_u64)(XXH_get32bits(ptr)) * XXH_PRIME64_1;
      ...
      (%plus-eq $ptr 4)
      ;; h64 = XXH_rotl64(h64, 23) * XXH_PRIME64_2 + XXH_PRIME64_3;
      (local.set $h64 (i64.add (i64.mul (%XXH_ROTL $h64 23) (%xxh_prime_2)) (%xxh_prime_3)))
      ;; len -= 4;
      (%minus-eq $len 4)))
  ;; }

  ;; while (len > 0) {
  (block $wlen_end (loop $wlen_start
  ...
  ;;     h64 ^= (*ptr++) * XXH_PRIME64_5;
      ...
      (%inc $ptr)
  ;;     h64 = XXH_rotl64(h64, 11) * XXH_PRIME64_1;
      (local.set $h64 (i64.mul (%XXH_ROTL $h64 11) (%xxh_prime_1)))
  ;;     --len;
      (%dec $len)
  ;; }
      (br $wlen_start)))
...
(func $xxh64 (param $input i32) (param $len i32) (param $seed i64) (result i64)
  ...
  (if (i32.ge_u (local.get $len) (i32.const 32))
    (then
      ...
      (local.set $v1 (i64.add (local.get $seed) (i64.add (%xxh_prime_1) (%xxh_prime_2))))
      ;; xxh_u64 v2 = seed + XXH_PRIME64_2;
      (local.set $v2 (i64.add (local.get $seed) (%xxh_prime_2)))
      ;; xxh_u64 v3 = seed + 0;
      (local.set $v3 (local.get $seed))
      ;; xxh_u64 v4 = seed - XXH_PRIME64_1;
      (local.set $v4 (i64.sub (local.get $seed) (%xxh_prime_1)))

      ;; do {
      (block $do_end (loop $do_start
      ...
      (local.set $h64 (i64.add (i64.add (i64.add
              (%XXH_ROTL $v1 1)
              (%XXH_ROTL $v2 7))
            (%XXH_ROTL $v3 12))
          (%XXH_ROTL $v4 18)))
      ...
      (local.set $h64 (call $xxh64_mergeRound 
          (call $xxh64_mergeRound
            (call $xxh64_mergeRound
              (call $xxh64_mergeRound (local.get $h64) (local.get $v1)) 
              (local.get $v2)) 
            (local.get $v3)) 
          (local.get $v4))))
    (else
      ;; h64 = seed + PRIME_5
      (local.set $h64 (i64.add (local.get $seed) (%xxh_prime_5)))))
